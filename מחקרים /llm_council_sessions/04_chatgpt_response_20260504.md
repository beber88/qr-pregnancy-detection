...
- **Metric:** primary = subject-level external AUROC על ה-holdout הכרונולוגי; secondary = calibration slope, calibration-in-the-large, Brier score, sensitivity/specificity ב-threshold שננעל מראש.
